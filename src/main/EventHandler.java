...
public class EventHandler {
    ...
    public void checkEvent() {
        ...
        if(canTouchEvent) {
            ...
            else if (hit(0, 12, 9, "any")) teleport(2, 9, 41, gp.dungeon);
            else if (hit(2, 9, 41, "any")) teleport(0, 12, 9, gp.outside);
            else if (hit(2, 8, 7, "any")) teleport(3, 26, 41, gp.dungeon);
            else if (hit(3, 26, 41, "any")) teleport(2, 9, 7, gp.dungeon);
        }
    }
